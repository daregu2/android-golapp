...
import com.example.golapp.databinding.ActivityStudentEditBinding;
...
public class StudentEditActivity extends AppCompatActivity {
    ActivityStudentEditBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validationHelper = new ValidationHelper(null, StudentEditActivity.this, true);
        ...
        binding.btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                studentService.update(student.getId(), request).enqueue(new Callback<BaseResponse<String>>() {
                    @Override
                    public void onResponse(Call<BaseResponse<String>> call, Response<BaseResponse<String>> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            Toasty.success(StudentEditActivity.this, response.body().getMessage()).show();
                            finish();
                        } else {
                            ...
                            try {
                                ...
                                assert error != null;
                                Toasty.error(StudentEditActivity.this, error.getMessage()).show();
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
                        }
                    ...
                    public void onFailure(Call<BaseResponse<String>> call, Throwable t) {
                        Toasty.error(StudentEditActivity.this, "ERROR").show();
                    }
                });
            }
        });
        ...
        schoolService.fetchSchools().enqueue(new Callback<BaseResponse<CollectionResponse<School>>>() {
            ...
            public void onResponse(Call<BaseResponse<CollectionResponse<School>>> call, Response<BaseResponse<CollectionResponse<School>>> response) {
                if (response.isSuccessful()) {
                    ...
                    adapterSchool = new ArrayAdapter<>(StudentEditActivity.this, R.layout.spinner_item, arraySchool);
    ...
    public void setupEditablePerson() {
        Intent i = getIntent();
        student = (Student) i.getSerializableExtra("person");
        binding.spinSchool.setText(student.getCycle().getSchool().getName(), false);
        binding.spinCycle.setText(student.getCycle().getName(), false);
        binding.txtLayoutNombres.getEditText().setText(student.getNames());
        binding.txtLayoutApellidos.getEditText().setText(student.getLastNames());
        binding.txtLayoutCodigo.getEditText().setText(String.valueOf(student.getCode()));
        binding.txtLayoutEmail.getEditText().setText(student.getEmail());
        binding.txtLayouTelefono.getEditText().setText(String.valueOf(student.getPhone()));
